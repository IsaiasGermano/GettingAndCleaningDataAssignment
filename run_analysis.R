...
# Putting files of the same type together 
### Train
...
# mergedDf <- merge(testSet, trainSet, by="id", all = TRUE)
...
names(buffer3) <- sub('^f', 'frequence', names(buffer3))
...
"frequenceBodyAccJerk-meanFreq()-X",
